...
class GCNNetOneLayer(nn.Module):
    """
    只有一层GraphConvolution的GCN模型
    """
    def __init__(self, input_dim, output_dim):
        dropout=0.001
        super(GCNNetOneLayer, self).__init__()
        allGCN1=[]
        allGCN2 = []
        self.input_dim=input_dim
        self.output_dim=output_dim
        ...
        self.dgcn1=GraphConvolution(output_dim,input_dim)
        ...
        self.dgcn2 = GraphConvolution(output_dim, input_dim)
    ...
    def forward(self, adjacency1, feature1,adjacency2,feature2):
        p0 = F.relu(self.gcn1(adjacency1, feature1))
        h1=F.relu(self.dgcn1(adjacency1, p0))
        # logits = self.gcn3(adjacency1, h0)

        p3 = F.relu(self.gcn2(adjacency2, feature2))
        h4 = F.relu(self.dgcn2(adjacency2, p3))
